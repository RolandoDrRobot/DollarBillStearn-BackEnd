...
dollarBillServer.post('/cancelOrder', (req: Request, res: Response) => {
  cancelOrder(vaultsDB, req.body.account, req.body.exchange, req.body.orderID, req.body.ticker).then(function(result:any){
    res.json(result);
  });
});
